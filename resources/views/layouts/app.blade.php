...
<head>
    ...
    @php $setting = getSetting()[0] @endphp
                    ...
                    <div class="col-lg-6">
                        <div class="text-md-end top-right-bar mt-2 mt-lg-0 call-now">
                            <a href="tel:+23-345-67890">
                                ...
                                <span class="h5">{{ $setting->phone }}</span>
                            </a>
                        </div>
                    </div>
                </div>
                    ...
                    <ul class="navbar-nav ms-auto">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                @if (!empty(featuredService()))
                                    <?php $featuredService = featuredService(); ?>
                                    @foreach ($featuredService as $item)
                                        <li><a class="dropdown-item" href="service-detail.html">{{ $item->name }}</a>
                                        </li>
                                    @endforeach
                    ...
                    <div class="widget widget-contact mb-5 mb-lg-0">
                        ...
                        <div class="footer-contact-block mb-4">
                            ...
                            <h4 class="mt-2"><i class="fa-solid fa-envelope"></i> <a
                                    href="mailto:example@example.com">{{ $setting->email }}</a></h4>
                            <h4 class="mt-2"><i class="fa-solid fa-phone-square" aria-hidden="true"></i> <a
                                    href="tel:+00-000-0000"> +91 {{ $setting->phone }}</a></h4>
                        </div>
