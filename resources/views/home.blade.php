                        ...
                        <div class="row align-items-center d-flex h-100">
                            <div class="col-md-7">
                                <div class="block">
                                    ...
                                    <h1 class="mb-3 mt-3">If you love life, don’t waste time, for time is what life is made
                                        up of</h1>
                                    <p class="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae laudantium
                                        quisquam aperiam maiores sunt fugit, deserunt rem suscipit placeat.</p>
                                    <div class="btn-container ">
                                        <a href="appoinment.html" target="_blank" class="btn btn-primary">Contact Now <i
                                ...
                                <div class="col-md-7">
                                    <div class="block">
                                        ...
                                        <p class="mb-4 pr-5">A repudiandae ipsam labore ipsa voluptatum quidem quae
                                            laudantium quisquam aperiam maiores sunt fugit, deserunt rem suscipit placeat.
                                        </p>
                                        <div class="btn-container ">
                                            <a href="appoinment.html" target="_blank" class="btn btn-primary">Contact Now <i
                                                    class="icofont-simple-right ml-2  "></i></a>
                        ...
                        @foreach ($data as $service)
                            <div class="card border-0 ">
                                ...
                                <div class="card-body p-3">
                                    <h1 class="card-title mt-2"><a href="{{ route('services.details', $service->id) }}">{{ $service->name }}</a></h1>
                                    <div class="content pt-2">
                                        <p class="card-text">{{ $service->short_description }}</p>
                                    </div>
                                    <a href="{{ route('services.details', $service->id) }}" class="btn btn-primary mt-4">Details <i
