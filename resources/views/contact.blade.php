                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-item mb-3">
                                <a href="#" class="text-white"> <i
                                        class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>Example Cop. Park Street, MI
                                    22222</a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3">
                                <a href="#" class="text-white"> <i class="fas fa-fw fa-phone-alt me-2"></i>(XXX)
                                    XXX-XXXX </a>
                            </li>
                            <!-- Email id -->
                    ...
                    <div class="card card-body shadow py-5 text-center h-100 border-0">
                        ...
                        <ul class="list-inline mb-0">
                            ...
                            <li class="list-item mb-3 h6 fw-light">
                                <a href="#"> <i class="fas fa-fw fa-map-marker-alt me-2 mt-1"></i>Example Cop. Park
                                    Street, MI 22222</a>
                            </li>
                            <!-- Phone number -->
                            <li class="list-item mb-3 h6 fw-light">
