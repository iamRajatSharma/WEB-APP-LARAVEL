                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('store') }}" class="btn btn-primary btn"><i class="fas fa-plus"></i>
                                Create</a>
                                    ...
                                    @if (count($services) > 0)
                                        @foreach ($services as $service)
                                            <tr>
                                                <td>{{ $service->id }}</td>
                                                <td>{{ $service->name }}</td>
                                                <td><img src="{{ asset('/uploads/services/thumb/small') }}/{{ $service->image }}"
                                                        height="50px;"></td>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('service.delete', $service->id) }}" method="POST"
                                                        ...
                                                        @method('delete')
                                                        <button type="submit"
                                                            onclick="return confirmBox({{ $service->id }})"
